...
export class ImageProcessingService {
  ...
  public server: string = "https://angularworkshop.cognitiveservices.azure.com/vision/v2.1/analyze?visualFeatures=Description,Tags";
  ...
  public analyzeImage(url: UrlObj): Observable<DescriptionTagRequest> {
    ...
    .post<DescriptionTagRequest>(this.server , url, httpOptions)
